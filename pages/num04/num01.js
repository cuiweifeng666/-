...
Page({
  ...
  question: function () {
    ...
    console.log(data);
    that.setData({
      que_t: data.data[3].title,
      que_d: data.data[3].answer,
    })
  ...
  nextQue: function () {
    ...
    console.log(select)
    if (select > -1) {
      var chooseData = data.data[3].answer[select-1].id;
      let sho = data.data[3].answer[select-1]
  ...
  ask: function (e) {
    ...
    var data = wx.getStorageSync('response');
     ...
     var percent = data.data[3].answer[ind - 1].percent;
     if (percent != 0) {
